...
username = os.environ['AAO_BET365_USERNAME']
password = os.environ['AAO_BET365_PASSWORD']
...
COMPETIONS = [
    ...
    ['germany', 'Germany', 'bundesliga_1', 'Germany Bundesliga I'],
    ['germany', 'Germany', 'bundesliga_2', 'Germany Bundesliga II'],
]
